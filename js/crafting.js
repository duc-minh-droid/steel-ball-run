...
SBR.MATERIALS = {
  scrap:     { name: 'Scrap Iron', rarity: 'common', desc: 'Bent nails, horseshoes, a broken spur.' },
  leather:   { name: 'Leather Strip', rarity: 'common', desc: 'Tanned and tough. Smells like saddle.' },
  cloth:     { name: 'Calico Cloth', rarity: 'common', desc: 'Printed cotton from a general store.' },
  powder:    { name: 'Gunpowder', rarity: 'common', desc: 'Keep it dry. Keep it away from Oyecomova.' },
  ...
  silver:    { name: 'Silver Nugget', rarity: 'uncommon', desc: 'Nevada silver, if the seller was honest.' },
  gold:      { name: 'Gold Nugget', rarity: 'rare', desc: 'Might be from Sugar Mountain\'s spring.' },
  ...
  herb:      { name: 'Prairie Sage', rarity: 'common', desc: 'Bitter, fragrant, medicinal.' },
...
SBR.EQUIPMENT = {
  // ---- weapons
  knife:          { slot: 'weapon', name: 'Bowie Knife', rarity: 'common', stats: { aim: 2, grit: 1 }, bonus: { bleedOnBasic: 0.15 }, recipe: { scrap: 2, leather: 1 }, price: 35 },
